...
@Component({
  selector: 'app-ejercicios-clase01',
  templateUrl: './ejercicios-clase01.component.html',
  styleUrls: ['./ejercicios-clase01.component.scss']
})
export class EjerciciosClase01Component {
